                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="norek" value="<?=$this->input->post('norek') ?? $data->norek ?>" id="norek" type="text" placeholder="0362xxxx..">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="namaakun" value="<?=$this->input->post('namaakun') ?? $data->namaakun?>" id="namaakun" type="text" placeholder="John Doe..">
