    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    <form action="<?php echo site_url('jasaservice/updatemybooking')?>" method="post">
                        <input type="hidden" name="id" value="<?=$this->session->userdata('userid') ?? $row->orderid?>"></input>
                        <!-- <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <label class="invalid-text" for="nohp"><?php echo form_error('jam'); ?></label>
                                </div>     
                            </div>
                        </div>
