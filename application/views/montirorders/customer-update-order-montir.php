    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    <form action="<?php echo site_url('jasamontir/updatemyorder')?>" method="post">
                    <input type="hidden" name="id" value="<?=$this->input->post('id') ?? $row->orderid ?>"></input>
                        <input type="hidden" name="userid" value="<?=$this->session->userdata('userid') ?? $row->userid?>"></input>
                        <!-- <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nama">Nama</label>
                                    <input class="form-control" name="nama" value="<?=$this->input->post('nama') ?? $row->nama?>" id="nama" type="text" placeholder="John Doe..">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="type" value="<?=$this->input->post('type') ?? $row->type?>" id="type" type="text" placeholder="Vario, Nmax, dll..">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alamatlengkap" name="alamatlengkap" rows="2"><?=$this->input->post('alamatlengkap') ?? $row->alamatlengkap?></textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="kendala" name="kendala" rows="2"><?=$this->input->post('kendala') ?? $row->kendala?></textarea>
