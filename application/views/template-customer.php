    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?=$active_menu == 'dashboard' ? 'active' : null?>">
                <a class="nav-link" href="<?=site_url('dashboardcustomer')?>">
            ...
            <li class="nav-item <?=$active_menu == 'service-motor' ? 'active' : null?>">
                <a class="nav-link" href="<?=site_url('jasaservice/myservicelist')?>">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Service Motor</span></a>
            </li>

            <li class="nav-item <?=$active_menu == 'jasa-montir' ? 'active' : null?>">
                <a class="nav-link" href="<?=site_url('jasaMontir/mymontirorders')?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?=site_url('users/userprofile')?>">
